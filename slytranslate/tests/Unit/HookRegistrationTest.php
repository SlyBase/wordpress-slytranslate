	...
	public function test_add_hooks_registers_expected_editor_and_ability_hooks(): void {
		...
		$this->assertSame(
			array(
				array(
					...
					'callback'      => array( AI_Translate::class, 'enqueue_editor_plugin' ),
					'priority'      => 10,
					'accepted_args' => 1,
				),
				array(
		...
		$this->assertSame(
			array(
				array(
					'hook'          => 'default_title',
					'callback'      => array( AI_Translate::class, 'default_title' ),
					'priority'      => 10,
					'accepted_args' => 2,
				),
				array(
					'hook'          => 'default_content',
					'callback'      => array( AI_Translate::class, 'default_content' ),
					'priority'      => 10,
					'accepted_args' => 2,
				),
				array(
					'hook'          => 'default_excerpt',
					'callback'      => array( AI_Translate::class, 'default_excerpt' ),
					'priority'      => 10,
					'accepted_args' => 2,
				),
				array(
					'hook'          => 'pll_translate_post_meta',
					'callback'      => array( AI_Translate::class, 'pll_translate_post_meta' ),
					'priority'      => 10,
					'accepted_args' => 3,
				),
			),
