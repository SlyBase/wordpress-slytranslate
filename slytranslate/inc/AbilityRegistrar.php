		...
		wp_register_ability( 'ai-translate/configure', array(
			...
			'input_schema'        => array(
				...
				'properties' => array(
					...
					'string_table_concurrency' => array( 'type' => 'integer', 'description' => 'Opt-in maximum concurrency for TranslatePress-style string-table batches. Values above 1 only activate when a successful concurrency probe recommends parallel execution for the active model.', 'minimum' => 1, 'maximum' => 4 ),
			...
			'output_schema'       => array(
				...
				'properties' => array(
					...
					'string_table_concurrency'         => array( 'type' => 'integer', 'description' => 'Configured opt-in maximum concurrency for string-table batch translation. Values above 1 still require a successful probe before they activate.' ),
					'string_table_concurrency_effective' => array( 'type' => 'integer', 'description' => 'Effective string-table concurrency after applying the probe recommendation and available transport.' ),
					'string_table_concurrency_recommended' => array( 'type' => 'integer', 'description' => 'Most recent recommended string-table concurrency for the active model based on the last probe result.' ),
					'string_table_concurrency_supported' => array( 'type' => 'boolean', 'description' => 'Whether a parallel HTTP transport is currently available for string-table concurrency.' ),
					'string_table_concurrency_transport' => array( 'type' => 'string', 'description' => 'Transport used for string-table concurrency, for example filtered_runner or wporg_requests.' ),
