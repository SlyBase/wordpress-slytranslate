...
### Fixes
- OpenRouter Nemotron models now use standard system/user chat prompts instead of bilingual-frame user-only prompts, matching the working direct API request shape and reducing prompt-instruction leakage.
