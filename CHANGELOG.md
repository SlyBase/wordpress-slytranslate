...
### Fixes
- OpenRouter Nemotron requests now normalize pasted label-style model slugs to the real connector id and use standard system/user chat prompts instead of bilingual-frame user-only prompts.
