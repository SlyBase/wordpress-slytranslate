...
- Reliability: OpenRouter Nemotron profiles now forward reasoning-disable and provider-parameter requirements through the WP AI Client connector, making unsupported provider paths fail fast instead of silently ignoring the requested thinking controls.
